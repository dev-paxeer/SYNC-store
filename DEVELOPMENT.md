...
```bash
git remote add encore encore://web3-app-store-7o4i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/web3-app-store-7o4i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/web3-app-store-7o4i/settings/integrations/github)
